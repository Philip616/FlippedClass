...
public class GMailSender extends javax.mail.Authenticator {     
	 private String mailhost = "smtp.gmail.com";     
	    ...
	    public synchronized void sendMail(String subject, String body, String sender, String recipients,String from,String fromName) throws Exception {     
	        try{  
	      ...
	      /*  /*******2015.09.29 嚙踝蕭��嚙踐�嚙踐▽嚙踝蕭*******/
	        // create multipart
	     /*   Multipart multipart = new MimeMultipart();

	        // create bodypart with image and set content-id
	       MimeBodyPart messageBodyPart = new MimeBodyPart();
	        File testImage = new File("/storage/emulated/0/Download/", "test.png"); //嚙踝蕭��嚙踐�嚙踐��嚙踝��嚙踝����,�澗��嚙踝��嚙踝��餈�
	       ...
	       messageBodyPart.setDataHandler(new DataHandler(source));
	        ...
	        /***************嚙踝蕭�賂蕭�湛蕭��嚙踝蕭 http://goo.gl/OAZn5q ****************/
