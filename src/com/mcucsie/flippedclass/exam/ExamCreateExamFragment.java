...
public class ExamCreateExamFragment extends Fragment{
	...
	String[] str_input_ques,str_chooseA,str_chooseB,str_chooseC,str_chooseD,str_point,str_ans,str_type;
	String exam_name;
	String btntype = "";
		...
		public void run() {
			// TODO Auto-generated method stub
				...
				{						
					...
					for(int i = 0;i <= count_for_ques ; i++)
					{			
						MySQL_DB_Insert.FC_InputExam(str_input_ques[i], str_chooseA[i], str_chooseB[i], str_chooseC[i], str_chooseD[i], str_point[i], str_ans[i],str_type[i], course_ID, Integer.toString(exam_code));						
						MySQL_DB_Insert.insertExamInfo(course_ID,str_input_ques[i], str_chooseA[i], str_chooseB[i], str_chooseC[i], str_chooseD[i], str_ans[i], str_type[i]);
